...
const candidateNavItems: NavItem[] = [
  { href: "/candidate/dashboard", label: "Dashboard", icon: LayoutDashboard, match: "exact" },
  { href: "/candidate/dashboard/cv", label: "Hồ sơ & CV", icon: UserCircle2, match: "startsWith" },
  { href: "/candidate/dashboard/applied-jobs", label: "Việc đã ứng tuyển", icon: FileText, match: "startsWith" },
  { href: "/candidate/dashboard/saved-jobs", label: "Việc đã lưu", icon: Bookmark, match: "startsWith" },
  { href: "/candidate/dashboard/settings", label: "Cài đặt", icon: Settings, match: "startsWith" },
];

const pageMetaMap = [
  {
    match: "/candidate/dashboard",
    exact: true,
    title: "Tổng quan",
    subtitle: "Tóm tắt hồ sơ và hoạt động ứng tuyển gần đây.",
  },
  {
    match: "/candidate/dashboard/cv",
    title: "Hồ sơ & CV",
    subtitle: "Cập nhật hồ sơ và quản lý các CV của bạn.",
  },
  {
    match: "/candidate/dashboard/applied-jobs",
    title: "Việc đã ứng tuyển",
    subtitle: "Theo dõi trạng thái các hồ sơ đã nộp.",
  },
  {
    match: "/candidate/dashboard/saved-jobs",
    title: "Việc đã lưu",
    subtitle: "Danh sách việc làm bạn quan tâm để xem lại.",
  },
  {
    match: "/candidate/dashboard/settings",
    title: "Cài đặt",
    subtitle: "Tùy chỉnh trải nghiệm và bảo mật tài khoản.",
  },
];
...
function CandidateSidebar({ pathname }: { pathname: string }) {
...
export default function CandidateDashboardLayout({
  ...
  return (
    <SidebarProvider defaultOpen>
      <CandidateSidebar pathname={pathname} />
      <SidebarInset>
        <DashboardTopbar
                ...
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="rounded-full">
                    <Avatar className="h-8 w-8">
                      <AvatarImage src="" alt="Candidate avatar" />
